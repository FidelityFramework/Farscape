# Farscape Commercial License

## Overview

Farscape is available under a Commercial License for use in commercial products, services, and enterprise environments. This Commercial License provides rights and protections beyond those offered by the Apache License 2.0.

## Commercial License Benefits

The Commercial License for Farscape provides:

- **Expanded Usage Rights**: Full rights to use, modify, and distribute Farscape in commercial products and services without the restrictions of the Apache License 2.0

- **Patent Rights**: Explicit patent license covering the Fidelity Framework technology, including the "System and Method for Zero-Copy Inter-Process Communication Using BARE Protocol" (US Patent Application No. 63/786,247)

- **No Open Source Requirements**: Freedom from the obligation to open source your own code that integrates with Farscape

- **Legal Indemnification**: Protection against intellectual property claims related to your use of Farscape (available with Enterprise support tiers)
...
Farscape Commercial Licenses are available in several tiers:
...
- For embedding Farscape within products distributed to customers
...
2. Intended use case for Farscape
...
A: You need a Commercial License if you are using Farscape in a commercial product or service, if you want commercial support, or if you need to distribute Farscape as part of a proprietary solution that you do not want to open source.

**Q: Can I try Farscape before purchasing a Commercial License?**

A: Yes, you can evaluate Farscape under the Apache License 2.0 for a limited period before deciding to purchase a Commercial License.

**Q: What happens when my Commercial License expires?**

A: You will need to renew your license to continue using Farscape commercially. Without renewal, you would need to transition to using Farscape under the Apache License 2.0 and comply with all its terms.
